...
//    public static final String AES_TYPE = "AES/ECB/NoPadding";
    ...
    //私钥
    private static final String AES_KEY="greatzhongtuozhl";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
    ...
    public static void main(String[] args) throws Exception {
        String content = "abcdefghigklmnopq";
        test(content);
    }
    ...
    public static void test(String content) throws UnsupportedEncodingException{
        ...
        // 解密
        String decryptResult = decrypt("7I5+E35yFNNgT33qOMSbDw==");
